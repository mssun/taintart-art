...
UNIMPLEMENTED_INTRINSIC(AddTaintInt)
UNIMPLEMENTED_INTRINSIC(GetTaintInt)
UNIMPLEMENTED_INTRINSIC(AddTaintShort)
UNIMPLEMENTED_INTRINSIC(GetTaintShort)
UNIMPLEMENTED_INTRINSIC(AddTaintBoolean)
UNIMPLEMENTED_INTRINSIC(GetTaintBoolean)
UNIMPLEMENTED_INTRINSIC(AddTaintByte)
UNIMPLEMENTED_INTRINSIC(GetTaintByte)
UNIMPLEMENTED_INTRINSIC(GetTaintVoid)
UNIMPLEMENTED_INTRINSIC(AddTaintLong)
UNIMPLEMENTED_INTRINSIC(GetTaintLong)
UNIMPLEMENTED_INTRINSIC(AddTaintIntArray)
UNIMPLEMENTED_INTRINSIC(GetTaintIntArray)
UNIMPLEMENTED_INTRINSIC(AddTaintByteArray)
UNIMPLEMENTED_INTRINSIC(GetTaintByteArray)
UNIMPLEMENTED_INTRINSIC(AddTaintShortArray)
UNIMPLEMENTED_INTRINSIC(GetTaintShortArray)
UNIMPLEMENTED_INTRINSIC(AddTaintBooleanArray)
UNIMPLEMENTED_INTRINSIC(GetTaintBooleanArray)
UNIMPLEMENTED_INTRINSIC(AddTaintCharArray)
UNIMPLEMENTED_INTRINSIC(GetTaintCharArray)
UNIMPLEMENTED_INTRINSIC(AddTaintLongArray)
UNIMPLEMENTED_INTRINSIC(GetTaintLongArray)
